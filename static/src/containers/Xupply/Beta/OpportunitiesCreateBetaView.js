...
class OpportunitiesCreateBetaView extends React.Component {
...
OpportunitiesCreateBetaView.defaultProps = {
    accountID: '',
    employeeID: '',
    fetchPublicRequests: f => f,
};
OpportunitiesCreateBetaView.propTypes = {
    accountID: PropTypes.string,
    employeeID: PropTypes.string,
    fetchPublicRequests: PropTypes.func,
    classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(OpportunitiesCreateBetaView);
